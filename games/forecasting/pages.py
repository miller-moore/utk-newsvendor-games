...
class ForecastingPage(Page):
    ...
    def js_vars(player: Player) -> dict:
        _vars = ForecastingPage.vars_for_template(player).copy()
...
class Instructions1(ForecastingPage):
    @staticmethod
    def is_displayed(player: Player):
        return player.round_number == 1


class Instructions2(ForecastingPage):
    @staticmethod
    def is_displayed(player: Player):
        return player.round_number == 1


class Instructions3(ForecastingPage):
    @staticmethod
    def is_displayed(player: Player):
        return player.round_number == 1
